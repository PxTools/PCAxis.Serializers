...
builder.SetPath(new Uri(@"..\..\..\..\UnitTests\TestFiles\BE0101N1.px", UriKind.Relative).ToString());
...
using (System.IO.FileStream stream = new System.IO.FileStream(new Uri(@"..\..\..\..\UnitTests\TestFiles\TestJson.json", UriKind.Relative).ToString(), FileMode.Create))
{
